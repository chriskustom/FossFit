...
Future<void> main() async => await integrationDriver(
      onScreenshot: (name, image, [args]) async {
        final deviceType = Platform.environment["FossFit_DEVICE_TYPE"];
        if (deviceType == null || deviceType.isEmpty)
          throw "FossFit_DEVICE_TYPE must be set, so integration driver knows where to save screenshots.";
        final isIos = Platform.environment["FossFit_IS_IOS"];
