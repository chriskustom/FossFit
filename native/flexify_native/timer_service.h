...
namespace FossFit {
    ...
    template <Platform P>
    TimerService<P>::TimerService() : shouldVibrate(false), timer(FossFitTimer<P>::emptyTimer()) {
    ...
    void TimerService<P>::updateAppUI() {
        ...
        FossFit::platform_specific::sendTickPayload<P>(payload, 4);
    }
